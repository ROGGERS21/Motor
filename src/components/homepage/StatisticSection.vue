...
<template>
  ...
  >
    <div
      ...
      :key="index"
      :class="[
        'p-6 h-36 md:h-72 w-full md:w-1/4 flex items-center md:justify-center gap-4',
    ...
    >
      ...
      <p class="text-lg w-10 text-gray-900 leading-tight">
        {{ item.label }}
      </p>
    </div>
  </section>
...
const stats = ref([
  ...
  { to: 25, label: "Total Branches", count: 0 }
]);
